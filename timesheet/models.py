...
class Timesheet(GenericClass):
    ...
    refer_client = models.ForeignKey('client.Client', verbose_name=_('client'), related_name="back_timesheet_client", null=True, blank=True, on_delete=models.CASCADE)
    refer_project = models.ForeignKey('project.Project', verbose_name=_("project"), related_name="back_timesheet_project", null=True, blank=True, on_delete=models.CASCADE)
    users = models.ManyToManyField(User, blank=True, verbose_name=_("user"))
    tags = models.ManyToManyField(Tag, blank=True, verbose_name=_("tags"))
    refer_task = models.ForeignKey('task.Task', verbose_name=_('task'), related_name="back_timesheet_task", blank=True, null=True, on_delete=models.CASCADE, )
    ...
    def get_sorted_users(self):
        ...
        d = {'users_in_task':users_in_task, 'users_in_project':users_in_project, 'users_in_project_not_in_task':users_in_project_not_in_task, 'users_in_client_not_in_project':users_in_client_not_in_project, 'users in_client':users_in_client}
        return d
    ...
    def get_sorted_tags(self):
        ...
        d = {'tags_in_task':tags_in_task, 'tags_in_project':tags_in_project, 'tags_in_project_not_in_task':tags_in_project_not_in_task, 'tags_in_client_not_in_project':tags_in_client_not_in_project, 'tags in_client':tags_in_client}
        return d
